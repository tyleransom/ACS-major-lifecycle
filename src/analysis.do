...
*-------------------------------------------------------------------------------
* Graphs: age-earnings profiles by major, age-employment profiles by major
* 
* Extensions:
...
preserve
    ...
    * mean
    ...
    graph export "../exhibits/avg_earnings_by_major_and_age.pdf", replace
    * median
    ...
    graph export "../exhibits/med_earnings_by_major_and_age.pdf", replace
restore
...
preserve
    ...
    * mean
    ...
    graph export "../exhibits/avg_ftfy_earnings_by_major_and_age.pdf", replace
    * median
    ...
    graph export "../exhibits/med_ftfy_earnings_by_major_and_age.pdf", replace
restore
...
preserve
    ...
    * all ages
    ...
    graph export "../exhibits/avg_resid_earnings_by_major_and_age.pdf", replace
    * age 26+
    ...
    graph export "../exhibits/avg_resid_earnings_by_major_and_age26.pdf", replace
    * median
    * all ages
    ...
    graph export "../exhibits/med_resid_earnings_by_major_and_age.pdf", replace
    * age 26+
    ...
    graph export "../exhibits/med_resid_earnings_by_major_and_age26.pdf", replace
restore
...
preserve
    ...
    * all ages
    ...
    graph export "../exhibits/avg_resid_employed_by_major_and_age.pdf", replace
    * age 26+
    ...
    graph export "../exhibits/avg_resid_employed_by_major_and_age26.pdf", replace
    * median
    * all ages
    ...
    graph export "../exhibits/med_resid_employed_by_major_and_age.pdf", replace
    * age 26+
    ...
    graph export "../exhibits/med_resid_employed_by_major_and_age26.pdf", replace
restore
...
preserve
    ...
    * all ages
    ...
    graph export "../exhibits/avg_xb_earnings_by_major_and_age.pdf", replace
    * age 26+
    ...
    graph export "../exhibits/avg_xb_earnings_by_major_and_age26.pdf", replace
restore
...
preserve
    ...
    graph export "../exhibits/lifetime_vs_growth.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_growth_sized.pdf", replace
    ...
    graph export "../exhibits/coef_vs_growth_sized.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_avg_growth.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_avg_growth_sized.pdf", replace
    ...
    graph export "../exhibits/coef_vs_avg_growth_sized.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_growth_top15.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_growth_sized_top15.pdf", replace
    ...
    graph export "../exhibits/coef_vs_growth_sized_top15.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_avg_growth_top15.pdf", replace
    ...
    graph export "../exhibits/lifetime_vs_avg_growth_sized_top15.pdf", replace
    ...
    graph export "../exhibits/coef_vs_avg_growth_sized_top15.pdf", replace
    */
    ...
    graph export "../exhibits/age46v26_top15.pdf", replace
    ...
    graph export "../exhibits/age46v26_sized_top15.pdf", replace
restore
...
*-------------------------------------------------------------------------------
* Extensions:
* 1. model extensive/intensive margins separately
* 2. focus on full-time, full-year workers
* 3. add race/sex/survey-year interactions
* 4. what about qincwage instances? maybe these are bad and should be dropped
*-------------------------------------------------------------------------------

* 1. model extensive/intensive margins separately
* extensive margin
logit mi_wage `covars'
* intensive margin
reg logwage `covars' if ~mi_wage, r

* 2. focus on full-time, full-year workers
reg logwage `covars' if s

* 3. add interactions
local inters1  c.age##c.age##b5.race##b1.sex i.year
local inters2 c.age##c.age##b5.race##b1.sex##i.year
reg incwage `inters1', r
reg log1pwage `inters1', r
reg logwage `inters1' if ~mi_wage, r
* inters2 has a lot of insiginificant coefficients and may be overfit

* 4. sensitivity to qincwage?
